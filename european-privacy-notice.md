...
| Legal basis |Purpose|Data|
| --- |---|---|
|**Where we have a contract with you, to perform that contract.** | <ul><li>Operate, maintain and provide our Website and Services</li><li>Create and maintain your account, and enable you to log in and update your account and profile</li><li>Respond to any requests you send us about our Services and provide you with information you have specifically requested</li><li>Send you technical updates, security alerts, and other support and service-related messages</li></ul> | <ul><li>Name, contact information and other account information</li><li>Information we receive from third party social networks or authentication services such as Google or Apple</li><li>Device information (such as IP address and browser type)</li><li>Messages you send to us and other information you choose to provide us</li></ul>|
|**With your consent**| <ul><li>Send you promotional or marketing materials in accordance with your marketing preferences</li></ul> | <ul><li>Name and contact information</li></ul>|
|**As necessary for our legitimate interests**|<ul><li>Respond to any general contact you make with us through the Website</li><li>Provide you with customer support and training through our Clever Academy</li><li>Ensure the security of our Website and Services</li><li>Send you promotional or marketing materials in accordance with your marketing preferences, and other marketing-related activities</li><li>Personalize, improve and develop new Services</li><li>Combine and anonymize data about our users and how they use the Services in order to create aggregate, anonymized statistics which we may use to provide certain features within the Services, and for promoting and improving the Services</li><li>Detect, prevent and respond to potential fraud, violations of our Terms of Use or other misuse of our Services</li></ul>|<ul><li>Name, contact information and other account information</li><li>Support requests you send to us and other support and training-related messages</li><li>Device information (such as IP address and browser type) and usage data (such as the pages you visit and the links you click)</li><li>Other information you choose to provide us</li></ul>|
